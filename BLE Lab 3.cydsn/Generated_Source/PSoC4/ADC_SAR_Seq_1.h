...
***************************************/
#define ADC_SAR_Seq_1_DEFAULT_SAMPLE_MODE_SEL        (1u)
#define ADC_SAR_Seq_1_DEFAULT_VREF_SEL               (3u)
...
#define ADC_SAR_Seq_1_DEFAULT_VREF_MV_VALUE          (1024)
...
#define ADC_SAR_Seq_1_DEFAULT_ACLKS_NUM              (4u)
...
#define ADC_SAR_Seq_1_SAR_CHAN_EN_REG             (*(reg32 *) CYREG_SAR_CHAN_EN )
#define ADC_SAR_Seq_1_SAR_CHAN_EN_PTR             ( (reg32 *) CYREG_SAR_CHAN_EN )

#define ADC_SAR_Seq_1_SAR_START_CTRL_REG          (*(reg32 *) CYREG_SAR_START_CTRL )
#define ADC_SAR_Seq_1_SAR_START_CTRL_PTR          ( (reg32 *) CYREG_SAR_START_CTRL )

#define ADC_SAR_Seq_1_SAR_DFT_CTRL_REG            (*(reg32 *) CYREG_SAR_DFT_CTRL )
#define ADC_SAR_Seq_1_SAR_DFT_CTRL_PTR            ( (reg32 *) CYREG_SAR_DFT_CTRL )

#define ADC_SAR_Seq_1_SAR_CHAN_CONFIG_REG         (*(reg32 *) CYREG_SAR_CHAN_CONFIG00 )
#define ADC_SAR_Seq_1_SAR_CHAN_CONFIG_PTR         ( (reg32 *) CYREG_SAR_CHAN_CONFIG00 )
#define ADC_SAR_Seq_1_SAR_CHAN_CONFIG_IND         CYREG_SAR_CHAN_CONFIG00

#define ADC_SAR_Seq_1_SAR_CHAN_WORK_REG           (*(reg32 *) CYREG_SAR_CHAN_WORK00 )
#define ADC_SAR_Seq_1_SAR_CHAN_WORK_PTR           ( (reg32 *) CYREG_SAR_CHAN_WORK00 )

#define ADC_SAR_Seq_1_SAR_CHAN_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT00 )
#define ADC_SAR_Seq_1_SAR_CHAN_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT00 )
#define ADC_SAR_Seq_1_SAR_CHAN_RESULT_IND         CYREG_SAR_CHAN_RESULT00

#define ADC_SAR_Seq_1_SAR_CHAN0_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT00 )
#define ADC_SAR_Seq_1_SAR_CHAN0_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT00 )

#define ADC_SAR_Seq_1_SAR_CHAN1_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT01 )
#define ADC_SAR_Seq_1_SAR_CHAN1_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT01 )

#define ADC_SAR_Seq_1_SAR_CHAN2_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT02 )
#define ADC_SAR_Seq_1_SAR_CHAN2_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT02 )

#define ADC_SAR_Seq_1_SAR_CHAN3_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT03 )
#define ADC_SAR_Seq_1_SAR_CHAN3_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT03 )

#define ADC_SAR_Seq_1_SAR_CHAN4_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT04 )
#define ADC_SAR_Seq_1_SAR_CHAN4_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT04 )

#define ADC_SAR_Seq_1_SAR_CHAN5_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT05 )
#define ADC_SAR_Seq_1_SAR_CHAN5_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT05 )

#define ADC_SAR_Seq_1_SAR_CHAN6_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT06 )
#define ADC_SAR_Seq_1_SAR_CHAN6_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT06 )

#define ADC_SAR_Seq_1_SAR_CHAN7_RESULT_REG         (*(reg32 *) CYREG_SAR_CHAN_RESULT07 )
#define ADC_SAR_Seq_1_SAR_CHAN7_RESULT_PTR         ( (reg32 *) CYREG_SAR_CHAN_RESULT07 )

#define ADC_SAR_Seq_1_SAR_CHAN_WORK_VALID_REG     (*(reg32 *) CYREG_SAR_CHAN_WORK_VALID)
#define ADC_SAR_Seq_1_SAR_CHAN_WORK_VALID_PTR     ( (reg32 *) CYREG_SAR_CHAN_WORK_VALID)

#define ADC_SAR_Seq_1_SAR_CHAN_RESULT_VALID_REG   ( *(reg32 *) CYREG_SAR_CHAN_RESULT_VALID )
#define ADC_SAR_Seq_1_SAR_CHAN_RESULT_VALID_PTR   ( (reg32 *) CYREG_SAR_CHAN_RESULT_VALID )
...
#define ADC_SAR_Seq_1_SAR_SATURATE_INTR_REG       (*(reg32 *) CYREG_SAR_SATURATE_INTR )
#define ADC_SAR_Seq_1_SAR_SATURATE_INTR_PTR       ( (reg32 *) CYREG_SAR_SATURATE_INTR )
...
#define ADC_SAR_Seq_1_SAR_RANGE_INTR_REG          (*(reg32 *) CYREG_SAR_RANGE_INTR )
#define ADC_SAR_Seq_1_SAR_RANGE_INTR_PTR          ( (reg32 *) CYREG_SAR_RANGE_INTR )
...
#define ADC_SAR_Seq_1_SAR_INJ_CHAN_CONFIG_REG     (*(reg32 *) CYREG_SAR_INJ_CHAN_CONFIG)
#define ADC_SAR_Seq_1_SAR_INJ_CHAN_CONFIG_PTR     ( (reg32 *) CYREG_SAR_INJ_CHAN_CONFIG)

#define ADC_SAR_Seq_1_SAR_INJ_RESULT_REG          (*(reg32 *) CYREG_SAR_INJ_RESULT )
#define ADC_SAR_Seq_1_SAR_INJ_RESULT_PTR          ( (reg32 *) CYREG_SAR_INJ_RESULT )

#define ADC_SAR_Seq_1_MUX_SWITCH0_REG             (*(reg32 *)  CYREG_SAR_MUX_SWITCH0 )
#define ADC_SAR_Seq_1_MUX_SWITCH0_PTR             ( (reg32 *)  CYREG_SAR_MUX_SWITCH0 )

#define ADC_SAR_Seq_1_MUX_SWITCH_HW_CTRL_REG      (*(reg32 *)  CYREG_SAR_MUX_SWITCH_HW_CTRL )
#define ADC_SAR_Seq_1_MUX_SWITCH_HW_CTRL_PTR      ( (reg32 *)  CYREG_SAR_MUX_SWITCH_HW_CTRL )

#define ADC_SAR_Seq_1_PUMP_CTRL_REG               (*(reg32 *)  CYREG_SAR_PUMP_CTRL )
#define ADC_SAR_Seq_1_PUMP_CTRL_PTR               ( (reg32 *)  CYREG_SAR_PUMP_CTRL )

#define ADC_SAR_Seq_1_ANA_TRIM_REG                (*(reg32 *)  CYREG_SAR_ANA_TRIM )
#define ADC_SAR_Seq_1_ANA_TRIM_PTR                ( (reg32 *)  CYREG_SAR_ANA_TRIM )

#define ADC_SAR_Seq_1_WOUNDING_REG                (*(reg32 *)  CYREG_SAR_WOUNDING )
#define ADC_SAR_Seq_1_WOUNDING_PTR                ( (reg32 *)  CYREG_SAR_WOUNDING )
...
#define ADC_SAR_Seq_1_VREF_INTERNALVREF          (0x00000000Lu)
#define ADC_SAR_Seq_1_VREF_INTERNALVREFBYPASSED  (0x00000000Lu)
...
#define ADC_SAR_Seq_1_NEG_VREF                   (0x00000E00Lu)
    ...
    #define ADC_SAR_Seq_1_NEG_OTHER              (uint16)((uint16)ADC_SAR_Seq_1_cy_psoc4_sarmux_8__VNEG << 9u)
#else
